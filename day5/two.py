...
def runTest():
    ...
    for line in lines:
        ...
        beingMoved = testCase[whereFrom][-nToMove:]
        del testCase[whereFrom][-nToMove:]
        testCase[whereTo].extend(beingMoved)
    print(testCase)
...
def run():
    with open("input.txt", "r") as f:
        for line in f:
            nToMove, whereFrom, whereTo = parseLine(line)
            beingMoved = startPosition[whereFrom][-nToMove:]
            del startPosition[whereFrom][-nToMove:]
            startPosition[whereTo].extend(beingMoved)
